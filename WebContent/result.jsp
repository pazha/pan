...
<script type="text/javascript">
	...
	function loadData(q,start){
		$.getJSON("http://113.10.139.102/server?jsoncallback=?",{q:q,start:start},function(result){
			if(result.length==0){
				alert("未搜索到结果，请换个关键字！");
			}else{
	...
	<tr>
		<td colspan="2">
			<p align="center" style="padding: 10px;">
				免责声明：本站搜索结果来自百度云，不存储任何内容，只提供信息检索服务，对其合法性概不负责，亦不承担任何法律责任。</br>
				©2016 <a href="http://www.inslow.com">inslow.com</a> Powered by <a href="https://cse.google.com">Google Custom Search</a> BetaV1.0&nbsp;
			</p>
		</td>
	</tr>
</table>
